...
// JVM_DefineModule defines a module, with the specified name, belonging to
// the specified class loader.  packages[] contains the complete (and final)
// list of the module's packages.
...
// JVM_AddModuleExports adds package to the list of packages that from_module exports.
// If to_module is NULL then package is unqualifically exported.  Otherwise,
// to_module is added to the list of modules to which package is exported.
...
// JVM_AddReadsModule adds to_module to the list of modules that from_module
// can read.
...
// JVM_CanReadModule returns TRUE if asking_module can read target_module.
...
// JVM_IsExportedToModule returns TRUE if package is exported from from_module
// to to_module, or if package is exported from from_module unqualifically.
