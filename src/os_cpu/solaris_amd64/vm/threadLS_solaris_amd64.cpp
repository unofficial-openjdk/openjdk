...
#pragma ident "@(#)threadLS_solaris_amd64.cpp	1.8 07/05/05 17:04:50 JVM"
#endif
/*
...
#include "incls/_threadLS_solaris_amd64.cpp.incl"

// From solaris_amd64.s
...
void ThreadLocalStorage::set_thread_in_slot(Thread *thread) {
  ...
  } else if (tlsMode == pd_tlsAccessDirect) {
    thr_setspecific(tlsKey, (void*)thread);
    // set with thr_setspecific and then readback with fs_load to validate.
