...
public class HashCollisionTest {
    ...
    void run() throws Exception {
        ...
        Scope emptyScope = WriteableScope.create(symtab.getUnnamedPackage(symtab.unnamedModule)); // any owner will do
        ...
        ClassSymbol cc = createClass(names.fromString("C"), symtab.getUnnamedPackage(symtab.unnamedModule));
