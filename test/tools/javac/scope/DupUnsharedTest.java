...
public class DupUnsharedTest {
    ...
    void runClashTest() throws Exception {
        WriteableScope emptyScope = WriteableScope.create(symtab.getUnnamedPackage(symtab.unnamedModule));
        ...
        Scope doubledEmptyScope = WriteableScope.create(symtab.getUnnamedPackage(symtab.unnamedModule));
        ...
        WriteableScope testScope1 = WriteableScope.create(symtab.getUnnamedPackage(symtab.unnamedModule));
        ...
        WriteableScope testScope2 = WriteableScope.create(symtab.getUnnamedPackage(symtab.unnamedModule));
