 ...
 *
 * @test
 * @build jdk.nashorn.api.scripting.test.Window jdk.nashorn.api.scripting.WindowEventHandler jdk.nashorn.api.scripting.test.VariableArityTestInterface jdk.nashorn.api.scripting.test.ScriptEngineTest
