...
public class VerifyStackTrace {
    ...
    static final class TestCase1 implements TestCase {
        ...
        private final String expected =
            "1: VerifyStackTrace.lambda$test$1([app]/VerifyStackTrace.java:209)\n" +
            "2: VerifyStackTrace$Handle.execute([app]/VerifyStackTrace.java:145)\n" +
            "3: VerifyStackTrace$Handle.run([app]/VerifyStackTrace.java:158)\n" +
            "4: VerifyStackTrace.invoke([app]/VerifyStackTrace.java:188)\n" +
            "5: VerifyStackTrace$1.run([app]/VerifyStackTrace.java:218)\n" +
            "6: java.security.AccessController.doPrivileged(java.base/Native Method)\n" +
            "7: VerifyStackTrace.test([app]/VerifyStackTrace.java:227)\n" +
            "8: VerifyStackTrace.main([app]/VerifyStackTrace.java:182)\n";
    ...
    static final class TestCase2 implements TestCase {
        ...
        private final String expected =
            "1: VerifyStackTrace.lambda$test$1([app]/VerifyStackTrace.java:211)\n" +
            "2: VerifyStackTrace$Handle.execute([app]/VerifyStackTrace.java:147)\n" +
            "3: VerifyStackTrace$Handle.run([app]/VerifyStackTrace.java:160)\n" +
            "4: VerifyStackTrace.invoke([app]/VerifyStackTrace.java:190)\n" +
            ...
            "9: VerifyStackTrace$1.run([app]/VerifyStackTrace.java:220)\n" +
            "10: java.security.AccessController.doPrivileged(java.base/Native Method)\n" +
            "11: VerifyStackTrace.test([app]/VerifyStackTrace.java:229)\n" +
            "12: VerifyStackTrace.main([app]/VerifyStackTrace.java:185)\n";
    ...
    static class TestCase3 implements TestCase {
        ...
        // test output in here (don't forget the final \n):
        private final String expected =
            "1: VerifyStackTrace.lambda$test$1([app]/VerifyStackTrace.java:213)\n" +
            "2: VerifyStackTrace$$Lambda$1/662441761.run([app]/Unknown Source)\n" +
            "3: VerifyStackTrace$Handle.execute([app]/VerifyStackTrace.java:149)\n" +
            ...
            "6: VerifyStackTrace$Handle.run([app]/VerifyStackTrace.java:162)\n" +
            "7: VerifyStackTrace.invoke([app]/VerifyStackTrace.java:192)\n" +
            ...
            "12: VerifyStackTrace$1.run([app]/VerifyStackTrace.java:222)\n" +
            "13: java.security.AccessController.doPrivileged(java.base/Native Method)\n" +
            "14: VerifyStackTrace.test([app]/VerifyStackTrace.java:231)\n" +
            "15: VerifyStackTrace.main([app]/VerifyStackTrace.java:188)\n";
