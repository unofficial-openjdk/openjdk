...
public class MyControl extends ResourceBundle.Control {
    private static final Set<Locale> mainLocales, euLocales, asiaLocales;

    static {
        mainLocales = new HashSet<>(Arrays.asList(Locale.ROOT, Locale.ENGLISH));
    ...
    @Override
    public Locale getFallbackLocale(String baseName, Locale loc) {
        return null;
    }

    protected static boolean isMainLocale(Locale locale) {
        return mainLocales.contains(locale);
    }
