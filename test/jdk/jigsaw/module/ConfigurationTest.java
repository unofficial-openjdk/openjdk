...
public class ConfigurationTest {
    ...
    /**
     * Basic test of two modules in the same (candidate) configuration
     * that export the same package.
     */
    @Test(expectedExceptions = { ResolutionException.class })
    public void testExports1() {
    ...
    /**
     * Basic test where a module exports a package that is in also exported
     * by a module in a Layer that is read by a module in the configuration.
     */
    @Test(expectedExceptions = { ResolutionException.class })
    public void testExports2() {

        // m2 exports java.lang
        ModuleDescriptor descriptor1
            =  new ModuleDescriptor.Builder("m1")
                .requires("m2")
                .requires("java.base")
    ...
    /**
     * Basic test of binding failing because a service provider module exports
     * the same package as another module in the (candidate) configuration.
     */
    @Test(expectedExceptions = { ResolutionException.class })
    public void testExports3() {
        ...
        ModuleDescriptor descriptor2
            = new ModuleDescriptor.Builder("m2")
                .provides("p.Service", "p.ServiceImpl")
                .exports("p")
                .build();
        ...
        // should throw ResolutionException because m1 and m2 export p
        cf.bind();
    }

    /**
     * Basic test of binding failing because a service provider module exports
     * the same package as a module in a Layer that is read by a module in the
     * configuration.
     */
    @Test(expectedExceptions = { ResolutionException.class })
    public void testExports4() {
        ...
        // should throw ResolutionException because m2 exports java.lang
        cf.bind();
    }
