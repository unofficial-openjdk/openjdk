...
@Bean
@Bean
                protected boolean prot(int C, Object DC, final Object EDC, final String... FEDC) { return true; }
    final @Bean
@Bean
@Bean
@Bean
                private boolean priv(int D, Object ED, final Object FED, final String... GFED) { return true; }
}
