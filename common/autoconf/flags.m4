...
[
  ...
  EXTRA_CFLAGS_JDK="$with_extra_cflags"
  EXTRA_CXXFLAGS_JDK="$with_extra_cxxflags"
  EXTRA_LDFLAGS_JDK="$with_extra_ldflags"
...
AC_DEFUN_ONCE([FLAGS_SETUP_BUILD_COMPILER_FLAGS],
[
